class Pokemon ():
    ...
    def __init__ (self, pokemon_name, pokemon_indexnr, pokemon_sprite, pokemon_picture, pokemon_type, pokemon_type2, pokemon_versionen = None):
        ...
        self.__pokemon_indexnr = pokemon_indexnr
        self.__pokemon_sprite = pokemon_sprite
        self.__pokemon_picture = pokemon_picture
        self.__pokemon_type = pokemon_type
        self.__pokemon_type2 = pokemon_type2
        self.__pokemon_versionen = pokemon_versionen

    def get_name(self):
        return self.__pokemon_name

    def get_indexnr(self):
        return self.__pokemon_indexnr

    def get_sprite(self):
        return self.__pokemon_sprite

    def get_picture(self):
        return self.__pokemon_picture

    def get_type(self):
        if self.__pokemon_type2 == None:
            return self.__pokemon_type
        else:
            return str(self.__pokemon_type, self.__pokemon_type2)

    def get_versionen(self):
        return self.__pokemon_versionen
...
print(Pokemon.pokedex[-1].get_name())
Pokemon.pokedex.append("hallo")
print(Pokemon.pokedex[-1])
print(Pokédex_Uranium[0].get_name())
