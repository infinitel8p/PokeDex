...
def Search(pokemon_search_input):
    ...
    english_language = [f"Pokémon '{pokemon_search_input}' could not be found!"]
    german_language = [f"Pokémon '{pokemon_search_input}' konnte nicht gefunden werden!"]
    ...
    german_language.insert(1, f"Entwicklungsstufe {pokemon_search_input}: {pokemon_stage}")
    ...
    english_language.insert(2, f"Ger: {german_name}, Eng: {english_name}  -  IndexNr: {pokemon_indexnr}\n{stage}")
    german_language.insert(2, f"Deu: {german_name}, Eng: {english_name}  -  IndexNr: {pokemon_indexnr}\n{stage}")
    ...
    english_type_names = {"Bug": ["Pokémon type: *Bug*\n", "Double damage: \n - Fire \n - Flying \n - Rock", "Half damage: \n - Grass \n - Fighting \n - Ground", "No damage: \n", "n / a"],
                        ...
                        "Normal" : ["Pokémon type: *Normal*\n", "Double damage: \n - Fighting", "Half damage:", "Half damage: \n - Ghost\n", "n / a"],
    ...
    english_language.append("Effect: ")
    german_language.append("Effekt: ")
    #set pokemon information language to selected language
    if current_languge == "english":
